...
def twitter_search_keyword():
    ...
    # Search
    tweets = twitter_search.search.tweets(q='RBA', lang='en', until = time.strftime("%Y-%m-%d"), count = 100)
    ...
    the_file = open('C:\\Users\\raja.bellebon\\Desktop\\Tweets_data_raw_RBA.txt','a+')
...
def remove_duplicates():
    f = open('C:\\Users\\raja.bellebon\\Desktop\\Tweets_data_raw_RBA.txt')
    lines = f.readlines()
    list(set(lines))        
    outfile = open('C:\\Users\\raja.bellebon\\Desktop\\Tweets_data_raw_RBA.txt', "w")
